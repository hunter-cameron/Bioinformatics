...
# for a few hundred million reads, x=3e9 (16G) should be enough
...
if [ ! -e k20_C20.kh ]; then
    ...
    normalize-by-median.py -p --ksize 20 -C 20 --n_tables 4 -x 3e9 --savetable k20_C20.kh $base_paired_f 1>&2 
    normalize-by-median.py --ksize 20 -C 20 --n_tables 4 -x 3e9 --loadtable k20_C20.kh --savetable k20_C20.kh $base_single_f 1>&2
...
# concatenate and zip the single reads
